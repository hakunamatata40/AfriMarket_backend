...
% ─── Double table des matières (Sommaire court + TdM complète) ────
% etoc permet de générer deux TOC indépendantes :
%   \etocsettocdepth{1}  → Sommaire (chapitres seulement)
%   \etocsettocdepth{3}  → Table des matières complète (sections/sous-sections)
\usepackage{etoc}
...
% ─── Abréviations (acronymes) — chargé APRÈS hyperref ─────
% glossaries-extra doit être chargé après hyperref pour que les liens
% hypertextes dans la liste des abréviations fonctionnent correctement.
% "toc" retiré pour éviter conflit avec etoc ; TOC ajoutée manuellement.
\usepackage[
  acronym,       % crée le type "acronyme" séparé du glossaire principal
  nonumberlist,  % pas de numéros de page dans la liste
  nopostdot,     % pas de point final après chaque définition
  nomain         % désactive le glossaire principal (acronymes seulement)
]{glossaries-extra}
% glossaries-extra est le successeur moderne de glossaries ;
% il gère mieux les conflits avec hyperref et biblatex.
\makeglossaries
...
%  Syntaxe : \newacronym{clé}{SIGLE}{Développement complet}
%  Usage dans le texte : \gls{clé}  ou  \acrshort{clé}
%  La première occurrence affiche "Développement (SIGLE)",
%  les suivantes affichent seulement "SIGLE".
% ============================================================
...
\newacronym{fcfa}{FCFA}{Franc de la Coopération Financière en Afrique centrale}
...
% ============================================================
%  SOMMAIRE (version courte — chapitres uniquement)
%  Utilise etoc pour générer une TOC indépendante limitée au niveau 0
%  (chapitres). La table des matières complète est en fin de document.
%  \etocsettocstyle et \etocsettocdepth contrôlent le rendu local
%  sans affecter la TOC principale générée plus loin.
% ============================================================
\clearpage
{
  \renewcommand{\contentsname}{Sommaire}
  % Profondeur locale : 0 = chapitres seulement (parts=−1, chapters=0, sections=1…)
  \etocsettocdepth{chapter}
  % On génère une TOC locale indépendante (ne modifie pas le .toc principal)
  \localtableofcontents*
  % Ajout manuel dans la TOC principale pour que le Sommaire y figure
...
% ============================================================
%  LISTE DES ABRÉVIATIONS — générée automatiquement
%  Prérequis : exécuter "makeglossaries rapport_AfriMarket"
%  entre les deux dernières passes pdflatex.
%
%  Ordre de compilation complet :
%    1. pdflatex rapport_AfriMarket
%    2. makeglossaries rapport_AfriMarket   ← génère le fichier .acr
%    3. bibtex rapport_AfriMarket
%    4. pdflatex rapport_AfriMarket
%    5. pdflatex rapport_AfriMarket         ← tout est résolu
%
%  Sous TeXstudio : Tools > Commands > Makeglossaries (ou F1 si configuré)
% ============================================================
\printglossary[
  type=\acronymtype,            % affiche uniquement les acronymes
  title={Liste des Abréviations},
  style=long,                   % rendu en tableau 2 colonnes : SIGLE | Développement
  nogroupskip                   % pas d'espace entre les groupes alphabétiques
]
% Ajout manuel dans la TOC (car option "toc" du package est désactivée)
...
% ============================================================
%  TABLE DES MATIÈRES COMPLÈTE (en fin de document)
%  Générée automatiquement par etoc avec profondeur maximale.
%  Liste tous les chapitres, sections, sous-sections et
%  sous-sous-sections avec leurs numéros de page.
% ============================================================
\clearpage
\etocsettocdepth{subsubsection}   % profondeur complète
